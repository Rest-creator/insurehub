        ...
        <div className="pt-8 mt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <Link to="/terms-of-service" className="text-sm text-gray-500 hover:text-insurance-orange transition-colors">
                Terms of Service
              </Link>
              <Link to="/contact" className="text-sm text-gray-500 hover:text-insurance-orange transition-colors">
                Contact
              </Link>
            </div>
          </div>
